// Shared FAQ content — used by both the public marketing /faq page and the
// in-app /dashboard/support page so the two never drift.
...
export const FAQS: FaqSection[] = [
  ...
  {
    category: 'Bank statements & your data',
    items: [
      {
        q: 'How does Equiscore read my bank data?',
        a: 'You upload a bank statement (PDF or CSV). We read it and build your profile from real income, spending and payment evidence. Live open-banking connections are coming soon, which will offer the strongest verified evidence.',
      },
      {
        q: 'Can Equiscore move money from my account?',
        a: 'No. We only ever read your data — from a statement you upload, and (when available) a read-only open banking connection. We cannot initiate payments, move money, or take any action on your account.',
      },
      {
      ...
      {
        q: 'What happens if I remove a statement?',
        a: 'Your existing verified data remains in your Trust Portfolio until you remove it. Removing a statement recalculates your profile without that data. You can upload a new statement at any time.',
      },
      {
