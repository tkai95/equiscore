    ...
    <div className="min-h-screen bg-ink">
      ...
      <section className="mx-auto max-w-6xl px-6 py-24">
        <div className="mb-16 max-w-xl">
          ...
          <h1 className="mb-6 text-4xl font-bold text-cream lg:text-5xl">Get in touch</h1>
        ...
        <div className="grid gap-6 md:grid-cols-3">
          {channels.map(({ icon: Icon, title, body, cta, href }) => (
            <div key={title} className="rounded-2xl border border-ink-border bg-ink-mid p-6">
              ...
              <h2 className="mb-2 font-semibold text-cream">{title}</h2>
              <p className="mb-4 text-sm leading-relaxed text-cream">{body}</p>
              <a href={href} className="text-sm font-medium text-teal hover:underline">
                {cta}
              </a>
            </div>
          ))}
        ...
        <div className="mt-16 rounded-2xl border border-ink-border bg-ink-mid p-8">
          <p className="mb-2 font-semibold text-cream">Looking for answers first?</p>
