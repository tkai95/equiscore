  ...
  return (
    <div className="min-h-screen bg-ink">
      ...
      <section className="mx-auto max-w-3xl px-6 py-24">
        <p className="mb-4 text-sm font-semibold uppercase tracking-wider text-teal">About</p>
        <h1 className="mb-8 text-4xl font-bold leading-tight text-cream lg:text-5xl">
          The UK financial system wasn&apos;t built for everyone.
        </h1>

        <div className="space-y-6 text-lg leading-relaxed text-cream">
          <p>
      ...
      <section className="bg-ink-mid py-24">
        <div className="mx-auto max-w-3xl px-6">
          <h2 className="mb-12 text-3xl font-bold text-cream">What we believe</h2>
          <div className="grid gap-8 sm:grid-cols-2">
            {[
              ...
              <div key={title} className="rounded-2xl border border-ink-border bg-ink p-6">
      ...
      <section className="mx-auto max-w-3xl px-6 py-24">
        <h2 className="mb-8 text-3xl font-bold text-cream">The team</h2>
        <p className="mb-10 text-lg leading-relaxed text-cream">
