    ...
    <main className="min-h-screen bg-white">
      ...
      <div className="mx-auto max-w-3xl px-6 py-20">
        ...
        <div className="prose prose-gray max-w-none space-y-10 text-gray-700">
          ...
          <section>
            <h2 className="mb-3 text-xl font-semibold text-gray-900">Acceptance of terms</h2>
            <p>
          ...
          <section>
            <h2 className="mb-3 text-xl font-semibold text-gray-900">What Equiscore provides</h2>
            <p>
          ...
          <section>
            <h2 className="mb-3 text-xl font-semibold text-gray-900">Your account</h2>
            <p>
              ...
              immediately at{' '}
              <a href="mailto:hello@equiscore.app" className="text-blue-600 hover:underline">
                hello@equiscore.app
              </a>
              .
            </p>
          ...
          <section>
            <h2 className="mb-3 text-xl font-semibold text-gray-900">Open Banking consent</h2>
            <p>
          ...
          <section>
            <h2 className="mb-3 text-xl font-semibold text-gray-900">Acceptable use</h2>
          ...
          <section>
            <h2 className="mb-3 text-xl font-semibold text-gray-900">Sharing your profile</h2>
            <p>
          ...
          <section>
            <h2 className="mb-3 text-xl font-semibold text-gray-900">Termination</h2>
            <p>
          ...
          <section>
            <h2 className="mb-3 text-xl font-semibold text-gray-900">Changes to these terms</h2>
            <p>
