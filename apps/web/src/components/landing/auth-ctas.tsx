...
// Auth-gated CTAs used in the nav. The nav composition (nav.tsx) decides
// whether to also show the waitlist button, and only when signed out.
// "Build my profile" lives only on the /sign-up page and at the end of the
// waitlist flow — NOT in the nav. Named `Dev*` for back-compat; neutral aliases
// below are preferred for new code.
